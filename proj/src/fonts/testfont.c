...
extern int vg_draw_rectangle(int x, int y, int width, int height, uint32_t color);

// Acho que isto n devia ser definido aqui pq é util para mais coisas mas para já está aqui. 
...
// Hihi encontrei esta fonte num repositorio. Mas podemos mudar para uma melhor depois
